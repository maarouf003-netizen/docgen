...
public static class DocumentChangeTracker
{
    ...
    private static readonly Dictionary<string, string> FieldLabels = new(StringComparer.Ordinal)
    {
        ...
        [nameof(Document.NoFundsDemandNumber)] = "رقم كتاب المطالعة بعدم وجود أموال للتنفيذ عليها",
        [nameof(Document.NoFundsDemandDate)] = "تاريخ كتاب المطالعة بعدم وجود أموال للتنفيذ عليها",
        [nameof(Document.StartReferralNumber)] = "رقم كتاب الإحالة إلى البداية",
        [nameof(Document.StartReferralDate)] = "تاريخ كتاب الإحالة إلى البداية",
