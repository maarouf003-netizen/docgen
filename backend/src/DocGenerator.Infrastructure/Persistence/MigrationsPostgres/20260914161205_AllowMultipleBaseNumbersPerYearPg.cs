...
{
    /// <inheritdoc />
    public partial class AllowMultipleBaseNumbersPerYearPg : Migration
    {
        /// <inheritdoc />
        ...
        {
            // إعادة القيد الفريد تفشل طالما وُجدت صفوف مكررة لنفس (ملف، سنة) أو
            // (استئناف، سنة) — يُطبَّق Down فقط على قاعدة بلا تكرار.
            migrationBuilder.DropIndex(
                name: "IX_DocumentBaseNumbers_DocumentId_Year",
                table: "DocumentBaseNumbers");
