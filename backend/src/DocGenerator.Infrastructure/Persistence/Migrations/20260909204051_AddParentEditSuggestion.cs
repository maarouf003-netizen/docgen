        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposedCanonicalName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ProposedEntityType = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    ProposedCitationFormula = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ...
                    ReviewReason = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
