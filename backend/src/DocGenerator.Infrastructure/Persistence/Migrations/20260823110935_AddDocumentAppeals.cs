...
{
    /// <inheritdoc />
    public partial class AddDocumentAppeals : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppealTypeLabel = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    AppellantsJson = table.Column<string>(type: "text", nullable: false),
                    AppelleesJson = table.Column<string>(type: "text", nullable: false),
                    AppealedDecisionText = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    AppealedDecisionSummary = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    AppealedDecisionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    InspectionBookNumber = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    InspectionBookDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    GroundsSummary = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    NoticeNumber = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    NoticeDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AppellateCourt = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    AppealBaseNumber = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    AppealYear = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    ...
                    DefenseOpinion = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    RegistrationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DecisionNumber = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    DecisionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DecisionRuling = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    Outcome = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    StruckOffDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    StruckOffDecisionNumber = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReminderDuration = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ReminderColor = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    CreatedById = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
