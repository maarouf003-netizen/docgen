...
public class ConsiderDelegationExecutedTests : IDisposable
{
    ...
    public ConsiderDelegationExecutedTests()
    {
        ...
        _service = new DocumentService(
            ...
            new Repository<DocumentOccurrence>(_db), new DelegationRepository(_db), new AppealRepository(_db), uow, tx, _audit, Microsoft.Extensions.Options.Options.Create(new DocGenerator.Application.Common.ExportOptions()));
    }
