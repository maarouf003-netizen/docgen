...
public class EntityManagerPortalGuardTests
{
    ...
    [InlineData("/api/portal/files/1/execution-actions")]
    [InlineData("/api/portal/files/1/delegations")]
    [InlineData("/api/portal/files/1/appeals/details")]
    [InlineData("/api/portal/files/1/base-numbers")]
    [InlineData("/api/portal/files/1/correspondence")]
