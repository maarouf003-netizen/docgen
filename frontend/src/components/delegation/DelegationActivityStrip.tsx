 ...
 * فقط (حُذف من بطاقة «تشعبات الملف» للمنيب توحيدًا مع سطر «بانتظار الإتمام» البنفسجي —
 * كل حالاته مغطاة هناك بالشارة والسطر والأزرار)؛ ويُغذّى من
 * GET /alerts/by-delegation/{id} المتاح لأطراف الإنابة فقط.
